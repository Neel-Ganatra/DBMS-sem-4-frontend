...
const Players = () => {
  ...
  const deletePlayer = (playerId) => {
    ...
    axios
      .delete(`/admin/player/${playerId}`) // Use proper string interpolation
      .then((res) => {
          ...
          >
            <div className="three-ones">
              <div className="Employee_search_divv">
                <span className="Order-history-span">Players</span>
              ...
              <Link to={ROUTES.ADD_PLAYER} className="btn btn-success">
                Add Player
              </Link>
            </div>
          </div>
                  ...
                  <td>
                    <div className="d-flex gap-2 w-100">
                      ...
                      <button
                        ...
                        onClick={() => navigate(ROUTES.EDIT_PLAYER + player.id)}
                      >
                        <img src={edit} alt="" />
                      </button>
                    </div>
